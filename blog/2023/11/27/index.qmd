...
1. Down load data GSE154778_RAW.tar from [here](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE154778) to data and unzip it.
2. Preprocess sequencing data

```{r}
#| eval: false
#| 
# Change working directory
setwd("./learn/2023_scRNA/data/GSE154778_RAW/")
# getwd()
# Check files
fs <- list.files("./", "^GSM")
...
saveRDS(sce.all, here("learn", "2023_scRNA", "sce.all.rds"))
```
#### Filter

```{r}
sce.all <- readRDS(here("learn", "2023_scRNA", "sce.all.rds"))
